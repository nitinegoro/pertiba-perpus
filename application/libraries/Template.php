...
class Template
{
	...
	public function view($content, $data = NULL)
	{
        ...
        else
        {
            ...
            $this->template['main_header']     = $this->ci->load->view('_template/main_header', $data, TRUE);
            $this->template['main_sidebar']    = $this->ci->load->view('_template/sidebar_menu', $data, TRUE);
