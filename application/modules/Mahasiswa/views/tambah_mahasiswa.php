...
<?php  
echo form_open_multipart(site_url('mahasiswa/insert'), array('id' => 'form-tambah-mahasiswa'));
?>
	  <div class="form-group col-md-12">
		...
		<div class="form-group col-md-12">
	  		...
	  		<div class="col-sm-4">
	    		<input type="text" name="npm" class="form-control" id="" placeholder="" required="">
	  		</div>
		</div>
		<div class="form-group col-md-12">
		...
		<div class="form-group col-md-12">
	  		...
	  		<div class="col-sm-8">
				<div class="radio">
					<label>
						<input type="radio" name="gender" value="Laki-laki" class="ace" required="" />
						<span class="lbl"> Laki-laki</span>
					</label>
					<label>
						<input type="radio" name="gender" value="Perempuan" class="ace" required="" />
		...
		<div class="form-group col-md-12">
	  		...
	  		<div class="col-sm-4">
				<div class="input-group">
					...
					<input name="tgl_lahir" class="form-control date-picker" type="text" placeholder="Contoh : <?php echo date('Y-m-d') ?>" required="">
				</div>
	  		</div>
		</div>
		<div class="form-group col-md-12">
	  		...
	  		<div class="col-sm-4">
	    		<input name="thn_masuk" type="text" class="form-control" id="" placeholder="Contoh : 2015/2016">
	  		</div>
		</div>
		<div class="form-group col-md-12">
	  		<label for="" class="col-sm-3 control-label">Program Studi</label>
	  		<div class="col-sm-8">
	    		<input name="program" type="text" class="form-control" id="" placeholder="">
	  		</div>
		</div>
		<div class="form-group col-md-12">
		...
		<div class="form-group col-md-12">
	  		...
	  		<div class="col-sm-8">
	    		<input name="konsentrasi" type="text" class="form-control" id="" placeholder="">
	  		</div>
		</div>
	  <div class="form-group col-md-12" style="margin-top: 20px;">
		...
		<div class="form-group col-md-12">
	  		...
	  		<div class="col-sm-8">
	    		<input name="barcode" type="text" class="form-control" id="" placeholder="">
	  		</div>
		</div>
		<div class="form-group col-md-12">
		...
		<div class="form-group col-md-12">
	  		...
	  		<div class="col-sm-4 col-sm-offset-1">
	    		<img id="preview-image" src="<?php echo base_url("assets/foto-ktm/temp.jpg"); ?>" alt="" class="img-thumbnail" width="200" height="300">
			</div>
		</div>
	    <div class="col-md-12">
	  	  	<hr>
...
<?php  
/* End of file tambah_mahasiswa.php */
/* Location: ./application/modules/Mahasiswa/views/tambah_mahasiswa.php */
?>